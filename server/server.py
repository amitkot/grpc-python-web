...
books_by_category = {
    BookCategory.MYSTERY: [
        BookRecommendation(id=1, title="The Matlese Falcon"),
...
class RecommendationService(books_pb2_grpc.RecommendationsServicer):
...
def serve():
    ...
    books_pb2_grpc.add_RecommendationsServicer_to_server(
